...
class AwaitStkMembership extends StatefulWidget {
  final String reference;

  const AwaitStkMembership({super.key, required this.reference});

  @override
  State<AwaitStkMembership> createState() => _AwaitStkMembershipState();
}

class _AwaitStkMembershipState extends State<AwaitStkMembership>
  ...
  Future<bool> _checkPurchaseStatus() async {
    try {
      final (response, errors) = await MembershipService().confirmMembership();
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Your registration, shares and savings purchase has been processed successfully. You can now view your updated portfolio in the dashboard.",
              textAlign: TextAlign.center,
              style: TextStyle(
                color: Colors.blueGrey.shade400,
                fontSize: 14,
