...
class _CreatePasswordState extends State<CreatePassword> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildRequirementItem("Minimum 8 characters in length"),
          _buildRequirementItem(
            "At least one uppercase (A-Z) and lowercase letter",
          ),
          _buildRequirementItem(
            "A numerical digit (0-9) and one special symbol (@, #, \$, %)",
          ),
        ],
      ),
    );
  ...
  Widget _buildRequirementItem(String text) {
    return Padding(
      ...
      child: Row(
        children: [
          const Icon(Icons.circle, size: 4, color: Color(0xFF17C6C6)),
    ...
    return Center(
      child: RichText(
        text: TextSpan(
          ...
          children: [
            const TextSpan(text: "Securely stored? "),
            TextSpan(
              text: "Sign In",
              style: const TextStyle(
                color: AnansiColors.darkBlue,
