...
class AwaitStkShares extends StatefulWidget {
  final String reference;
  final String id;

  const AwaitStkShares({super.key, required this.reference, required this.id});

  @override
  State<AwaitStkShares> createState() => _AwaitStkSharesState();
}

class _AwaitStkSharesState extends State<AwaitStkShares>
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              "Your share purchase has been processed successfully. You can now view your updated portfolio in the dashboard.",
              textAlign: TextAlign.center,
              style: TextStyle(
                color: Colors.blueGrey.shade400,
                fontSize: 14,
