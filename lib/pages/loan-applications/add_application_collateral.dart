...
class AddApplicationCollateral extends StatefulWidget {
  final String appId;
  const AddApplicationCollateral({
    super.key,
    required this.appId,
  });

  @override
  State<AddApplicationCollateral> createState() =>
      _AddApplicationCollateralState();
}

class _AddApplicationCollateralState extends State<AddApplicationCollateral> {
    ...
    try {
      ...
      if (errors != null) {
        ...
        Navigator.pushReplacement(
          ...
          MaterialPageRoute(
            builder: (context) =>
                ApplicationCollaterals(appId: widget.appId),
          ),
        );
      }
    } finally {
