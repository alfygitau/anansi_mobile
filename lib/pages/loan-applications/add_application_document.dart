...
class AddApplicationDocument extends StatefulWidget {
  final String appId;
  const AddApplicationDocument({super.key, required this.appId});

  @override
  State<AddApplicationDocument> createState() => _AddApplicationDocumentState();
}

class _AddApplicationDocumentState extends State<AddApplicationDocument> {
      ...
      if (errors != null) {
        ...
        if (mounted) {
          Navigator.pushReplacement(
            context,
            MaterialPageRoute(
              builder: (context) => ApplicationDocuments(appId: widget.appId),
            ),
          );
        }
      }
