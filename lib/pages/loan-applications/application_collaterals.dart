...
class ApplicationCollaterals extends StatefulWidget {
  final String appId;
  const ApplicationCollaterals({super.key, required this.appId});

  @override
  State<ApplicationCollaterals> createState() => _ApplicationCollateralsState();
}

class _ApplicationCollateralsState extends State<ApplicationCollaterals> {
      ...
      child: InkWell(
        onTap: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (context) =>
                  AddApplicationCollateral(appId: widget.appId),
            ),
          );
        },
        child: Container(
